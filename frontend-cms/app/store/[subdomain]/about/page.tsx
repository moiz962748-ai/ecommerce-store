...
import { Sparkles, ShieldCheck, Zap, Globe, Users, Target } from 'lucide-react';
...
export default function StoreAboutPage() {
  ...
  return (
    <main className="min-h-screen w-full transition-colors duration-300">
      ...
      {/* 1. Hero Header with Proper Top/Bottom Spacing */}
      <section className="mx-auto max-w-7xl px-4 pt-10 pb-8 sm:px-6 md:px-8 md:pt-14 md:pb-12 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight leading-tight">
          About <span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-500 bg-clip-text text-transparent">Our Platform</span>
        </h1>
      ...
      {/* 2. Core Pillars & Mission Cards (Clean Vertical Spacing) */}
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 md:px-8 border-t border-slate-800/60">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-3xl border border-slate-800/80 bg-slate-900/60 p-8 backdrop-blur-md shadow-xl">
            ...
            <p className="mt-2 text-xs leading-relaxed text-slate-400">
              Dispatched with high-grade bubble wrap and express tracking to over 50+ major cities across Pakistan.
            </p>
          </div>
