    ...
    <main className="min-h-screen bg-store-background text-store-foreground">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 md:px-8 md:py-12">
        <div className="mb-8 rounded-[28px] border border-store-border bg-store-card p-6 md:p-8">
          <p className="text-sm uppercase tracking-[0.25em] text-store-muted">Your basket</p>
          <h1 className="mt-3 text-4xl font-bold text-store-foreground store-heading">Shopping cart</h1>
        </div>
